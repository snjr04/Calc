...
// LimCalc.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLimCalcApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLimCalcApp

CLimCalcApp::CLimCalcApp()
{
...
// Единственный объект CLimCalcApp

CLimCalcApp theApp;


// Инициализация CLimCalcApp

BOOL CLimCalcApp::InitInstance()
{
